<head>
    ...
    <title>Un proche vous souhaite les meilleurs voeux</title>
    <style>
        body {
            background: #000;
            margin: 0;
    ...
    <style id="jsbin-css">
        ...
        @font-face {
            font-family: myfont;
            src: url(https://www.codespeedy.com/demophp/hny/myfont.TTF);
        }
        ...
        .btn-group button {
            ...
            touch-action: manipulation; /* Ajout de la propriété touch-action */
        }
...
<div class="wish" style="color: lime; font-size: 20px;">
    ...
    <div id="demo" style="color: lime; font-size: 15px;"></div>
    <div class="btn-group">
        <button id="answer">Répondre</button>
        @if($message->visibility == 'only me')
            <button id="anwsers-see">Voir les réponses</button>
        @else
            <a href="#"><button id="answers">Voir les réponses</button></a>
        @endif
        <a href="/"><button id="new">Créer votre lien</button></a>
    </div>
</div>
<!-- The Modal -->
        ...
        <div class="modal-body">
            ...
            <form id="messageForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="answerName" name="name" required>
                </div>
                <div class="form-group">
                    <label for="message">Message</label>
                    <textarea id="answerContent" name="message" rows="4" required></textarea>
                </div>
                <div class="form-group center">
                    <button type="button" onclick="new_answer({{ $message->id }})" id="sendMessage">Envoyer</button>
                </div>
            </form>
        </div>
...
var x = setInterval(function() {
    ...
    document.getElementById("demo").innerHTML ="Bonne et heureuse Année 2024 à vous!<br>En avance de <br>" +days + " Jour " + hours + " Heures "
    + minutes + " Minutes " + seconds + " Secondes";

    // If the count down is over, write some text
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("demo").innerHTML = "Profitez bien en 2024!";
    }
}, 1000);
...
<script src="/assets/js/rocket-loader.js" data-cf-settings="9e674192f66b3858be3f796d-|49" defer></script>
<script>
    (function(){var js = "window['__CF$cv$params']={r:'83c989f4ec6686ba',t:'MTcwMzc2MzczNi4wMzgwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();
</script>
<script>
    // Get the modal
    ...
    // Supposons que vous avez un bouton ou un déclencheur pour l'ajout de la réponse
    function new_answer (messageId) {
        console.log('new_answer');
        // Récupérer les valeurs à partir du formulaire ou d'autres éléments HTML
        var newName = $('#answerName').val();
        var newContent = $('#answerContent').val();

        // Faire la requête AJAX
        $.ajax({
            url: '/add-answer', // Assurez-vous d'ajuster l'URL en fonction de votre route Laravel
            type: 'POST',
            data: {
            ...
            success: function (response) {
                if (response.success) {
                    // Hide the form
                    $('#messageForm').hide();
                    // Show the success message and button
                    $('#successMessage').show();
                } else {
